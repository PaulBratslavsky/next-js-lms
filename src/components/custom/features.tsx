  ...
  return (
    <section className="container flex flex-col items-center gap-6 py-24 sm:gap-7">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl text-center">
        Reweb brings the best of two worlds together: the speed of development
        of no-code tools, and the flexibility of code customization.
      </p>
      <Carousel
                ...
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Edit HTML, Tailwind &amp; React components with a visual
                      builder and see your changes in real-time.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full shadow-md">
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Once you&apos;re done building, export your project to a
                      fully functional Next.js &amp; Tailwind app.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full shadow-md">
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      You own the code. Customize with full flexibility and host
              ...
              <Card className="h-full shadow-md">
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Reweb works with the most popular frontend technologies
                      like Next.js, Tailwind CSS and Shadcn UI.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full shadow-md">
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Get started quickly with pre-made templates and sections
                      to build your landing page fast.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="h-full shadow-md">
                <CardContent className="flex flex-col items-start gap-5 p-7">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Generate beautiful themes and color palettes with AI to
